...
| ✅ | 386 teste verzi · bundle iOS verificat **cu stilurile compilate** |
...
| S11.3 🔴 | **C12 — DPIA + registrul prelucrărilor** (Legea 195/2024, în vigoare din 23 aug 2026) — **ciornă scrisă**: registrul în `docs/20`, DPIA cu plan de măsuri în `docs/21`. Reparat pe loc ce contrazicea textele publicate: text liber în contextul pentru AI, acordul AI care nu se putea retrage, exportul incomplet, tokenul de push rămas activ după deconectare, formulare publice fără link spre politică. Retenția se aplică singură, în fiecare noapte (M-08, M-11): clickurile devin un total lunar după 24 de luni, istoricul reminderelor se șterge după 13 luni, sesiunile nefolosite după 12 luni. Rămân operatorul (A7), juristul și măsurile deschise din `docs/21 § 6` |
